...
# IntentionGym 训练脚本 - 单卡配置（仅卡2）
# 训练模型: Qwen3-4B (运行在卡2，80GB显存)
...
# ==================== 训练参数 ====================
# 单卡80GB显存配置：减小batch size以应对多轮对话的长序列
TRAIN_BATCH_SIZE=8            # 减小到8，实际batch为8*2=16（因为rollout.n=2）
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name='IntentionGym_Qwen4B_singleGPU2' \
